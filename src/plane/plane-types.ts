...
export const PLANE_TYPES: PlaneType[] = [
    ...
    { id: 'MANDELBROT_COMBINED', short: 'Mandelbrot Combined', description: 'Mandelbrot set visualization by combining number of iterations with approximated distance' },
